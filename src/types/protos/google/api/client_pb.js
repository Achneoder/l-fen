  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        break;
      case 2:
        var values = /** @type {!Array<!proto.google.api.ClientLibraryDestination>} */ (
...
proto.google.api.ClientLibrarySettings.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(21, f, proto.google.api.JavaSettings.serializeBinaryToWriter);
  }
  f = message.getCppSettings();
  if (f != null) {
    writer.writeMessage(22, f, proto.google.api.CppSettings.serializeBinaryToWriter);
  }
  f = message.getPhpSettings();
  if (f != null) {
    writer.writeMessage(23, f, proto.google.api.PhpSettings.serializeBinaryToWriter);
  }
  f = message.getPythonSettings();
  if (f != null) {
    writer.writeMessage(24, f, proto.google.api.PythonSettings.serializeBinaryToWriter);
  }
  f = message.getNodeSettings();
  if (f != null) {
    writer.writeMessage(25, f, proto.google.api.NodeSettings.serializeBinaryToWriter);
  }
  f = message.getDotnetSettings();
  if (f != null) {
    writer.writeMessage(26, f, proto.google.api.DotnetSettings.serializeBinaryToWriter);
  }
  f = message.getRubySettings();
  if (f != null) {
    writer.writeMessage(27, f, proto.google.api.RubySettings.serializeBinaryToWriter);
  }
  f = message.getGoSettings();
  if (f != null) {
    writer.writeMessage(28, f, proto.google.api.GoSettings.serializeBinaryToWriter);
  }
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.google.api.Publishing.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        methodSettingsList: jspb.Message.toObjectList(
          msg.getMethodSettingsList(),
          proto.google.api.MethodSettings.toObject,
          includeInstance
        ),
        ...
        librarySettingsList: jspb.Message.toObjectList(
          msg.getLibrarySettingsList(),
          proto.google.api.ClientLibrarySettings.toObject,
          includeInstance
        )
      };
...
proto.google.api.Publishing.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(2, f, proto.google.api.MethodSettings.serializeBinaryToWriter);
  }
  f = message.getNewIssueUri();
  if (f.length > 0) {
    writer.writeString(101, f);
  }
  ...
  if (f.length > 0) {
    writer.writeString(103, f);
  }
  f = message.getGithubLabel();
  if (f.length > 0) {
    writer.writeString(104, f);
  }
  f = message.getCodeownerGithubTeamsList();
  if (f.length > 0) {
    writer.writeRepeatedString(105, f);
  }
  f = message.getDocTagPrefix();
  if (f.length > 0) {
    writer.writeString(106, f);
  }
  f = message.getOrganization();
  if (f !== 0.0) {
    writer.writeEnum(107, f);
  }
  f = message.getLibrarySettingsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(109, f, proto.google.api.ClientLibrarySettings.serializeBinaryToWriter);
  }
};
...
proto.google.api.JavaSettings.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getCommon();
  if (f != null) {
    writer.writeMessage(3, f, proto.google.api.CommonLanguageSettings.serializeBinaryToWriter);
  }
};
...
proto.google.api.CppSettings.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getCommon();
  if (f != null) {
    writer.writeMessage(1, f, proto.google.api.CommonLanguageSettings.serializeBinaryToWriter);
  }
};
  ...
  proto.google.api.MethodSettings.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        longRunning:
          (f = msg.getLongRunning()) && proto.google.api.MethodSettings.LongRunning.toObject(includeInstance, f)
      };
...
proto.google.api.MethodSettings.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(2, f, proto.google.api.MethodSettings.LongRunning.serializeBinaryToWriter);
  }
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.google.api.MethodSettings.LongRunning.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        initialPollDelay:
          (f = msg.getInitialPollDelay()) && google_protobuf_duration_pb.Duration.toObject(includeInstance, f),
        ...
        totalPollTimeout:
          (f = msg.getTotalPollTimeout()) && google_protobuf_duration_pb.Duration.toObject(includeInstance, f)
      };
